...
export default class Home extends Component {
  ...
  render() {
    ...
    const iconURL = selfProfile.icon
      ? `url('https://ipfs.io/ipfs/${selfProfile.icon}')`
      : "#";
        ...
        <div className="h-100 flex justify-center items-start">
          <div className="minw5 dn db-l mw-post mv3 mh2-l  br3-l overflow-hidden ba b--light-gray bg-white">
            <Link to={id ? `/@${id}` : "#"}>
              <div
                ...
                style={{
                  backgroundColor: selfProfile.color
                    ? `#${selfProfile.color}`
                    : null,
                  backgroundImage: selfProfile.canopy ? backgroundURL : null
                }}
              />
            </Link>
            ...
            <div className="w5 minw55 mh3 mb3 minh4 pl05">
              ...
              <div className="flex items-center ">
                ...
                <div className="mt3 ph0 h-100 w-100 flex items-center justify-start">
                  ...
                  >
                    <div className="moon-gray tl hover-near-black">
                      <h3
                        style={{
                        ...
                        className="f5 mt0 mb0 near-black"
                      >
                  ...
                  <Link
                    ...
                    className="h-100 no-underline mr4"
                  >
                    <div className=" h-100    moon-gray hover-near-black">
                      <h3
                        style={{
                          color: selfProfile.color
                            ? `#${selfProfile.color}`
                  ...
                  <Link
                    ...
                    className="h-100 no-underline mr4"
                  >
                    <div className="  moon-gray hover-near-black">
                      <h3
                        style={{
                          color: selfProfile.color
                            ? `#${selfProfile.color}`
          ...
          <div className="mw75 flex w-100">
            ...
            <div className="dn db-xl pa3 mh2 br2 ba b--light-gray mt3 bg-white self-start">
              <div className="w5">
                <h2 className="f7 silver mv0 ttu moon gray">
                  {
                    "Online now"
                    // `${onlinePeers.length} ${onlinePeers.length === 1 ? "person" : "people"} online`
                  }
                </h2>
                {onlinePeers.length
                      ...
                      {onlinePeers.map(peerID => (
                        <li className="mv1" key={peerID}>
                          <Link
                            ...
                            className="db pointer link mv0 mr1 f6 fw6 near-black"
                          >
                            <span className="db break-all flex items-center">
                              ...
                              {following[peerID]
                                ? <svg
                                    ...
                                    fill={`#${profiles[peerID].color || "5856D6"}`}
                                    width="14px"
                                    viewBox="0 0 17 17"
                                  >
                                    <path
